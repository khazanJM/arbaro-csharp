...
{
    public class DXArbaroLeafMeshHelper
    {
        private float _length;
        private float _width;
        private float _stemLength;
        private int _leafType;  
        DXBaseArbaroTreeMesh _mesh;

        public DXArbaroLeafMeshHelper(float length, float width, float stemLength, string leafType, DXBaseArbaroTreeMesh mesh)
        {
            _length = length;
            _width = width;
